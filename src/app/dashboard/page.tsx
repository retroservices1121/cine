...
import { formatUsd, cn, relativeTime } from "@/lib/utils";
...
export default function DashboardPage() {
  ...
  const handleCreate = async (e: React.FormEvent) => {
    ...
    if (Number(liquidity) < 100) {
      setCreateError("Minimum liquidity is $100");
      return;
    }
  ...
  if (!authenticated) {
    return (
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 py-20 text-center fade-in">
        ...
        <p className="text-text-muted mb-6">Connect your wallet to manage markets</p>
            ...
            {createResult ? (
              <div className="text-center py-6">
                ...
                <div className="bg-bg rounded-lg p-3 mb-4 text-left">
                  ...
                  >
                    {createResult.contract_address}
                  </a>
                </div>
                <div className="flex gap-2 justify-center">
                  <Link
                    href={`/market/spredd/${createResult.contract_address}`}
                    className="px-4 py-2 bg-accent hover:bg-accent-hover text-white text-xs font-medium rounded-lg transition-colors"
                  >
                    View Market
                  </Link>
                  <button
                    onClick={() => { setCreateResult(null); setQuestion(""); setEndTime(""); }}
              ...
              <form onSubmit={handleCreate} className="space-y-4">
                ...
                {createError && (
                  <div className="p-2.5 bg-red-dim rounded-lg">
                  ...
                  >
                    ...
                    {m.contract_address && (
                      <button
                        ...
                        onClick={(e) => {
                          e.preventDefault();
                          setResolveAddr(m.contract_address!);
